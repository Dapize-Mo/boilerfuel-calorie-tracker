            ...
            <div className="bg-theme-bg-secondary rounded-2xl p-8 shadow-xl border border-theme-border">
              ...
              <div className="mt-6">
                ...
                <button
                  ...
                  className="mt-4 w-full py-3 px-4 bg-theme-bg-primary hover:bg-theme-bg-secondary text-theme-text-primary font-semibold rounded-lg transition-all shadow-md hover:shadow-lg border border-theme-border flex items-center justify-center gap-2"
                >
