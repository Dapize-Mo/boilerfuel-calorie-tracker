  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://boiler-calorie-tracker-v3.vercel.app/profile" />
        ...
        <meta property="og:url" content="https://boiler-calorie-tracker-v3.vercel.app/profile" />
      </Head>
            ...
            <div>
              ...
              {editingGoals ? (
                ...
                <div className="space-y-2">
                  ...
                  <Link href="/tools" className="text-[10px] uppercase tracking-widest text-theme-text-tertiary/60 hover:text-theme-text-primary transition-colors inline-flex items-center gap-1">
                    Calculate via TDEE calculator &rarr;
                  </Link>
                </div>
              )}
            </div>
