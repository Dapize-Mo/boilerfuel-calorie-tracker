...
const StatCard = React.memo(function StatCard({ label, value, goal, icon }) {
    ...
    return (
        <div className="p-8 rounded-3xl bg-theme-card-bg border border-theme-card-border shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-[1.02] hover:border-yellow-400/30 modern-card relative overflow-hidden group">
