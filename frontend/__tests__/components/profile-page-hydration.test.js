...
describe('profile page hydration', () => {
  beforeEach(() => {
  ...
  test('uses identical server and initial client markup across UTC midnight', async () => {
    ...
    const serverMarkup = renderToString(<MyApp Component={ProfilePage} pageProps={{}} />);
    ...
    let root;
    await act(async () => {
      root = hydrateRoot(container, <MyApp Component={ProfilePage} pageProps={{}} />, { onRecoverableError });
